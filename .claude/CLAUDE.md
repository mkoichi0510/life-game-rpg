...
## v1.0 リリース計画（確定: 2026-03-20）

| 項目 | 内容 |
|------|------|
| **v1.0スコープ** | 最小MVP（基本ゲームループ + ストリーク + 認証） |
| **リリース目標日** | **2026-04-30** |
| **MVP完了条件** | LIF-9（ストリーク機能）完了後にAppStore申請 |
| **Phase 2残タスク** | v1.1以降にスコープ外として先送り |
...
3. **ファイル同期**: CLAUDE.md を更新した場合は、AGENTS.md も同じ内容に更新
